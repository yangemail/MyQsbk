<template>
	<view class="index-list animated fadeInLeft fast">
		<view class="index-list1 u-f-align-center u-f-justfify-space-btw">
			<view class="u-f-align-center">
				<image :src="item.userpic" mode="widthFix" lazy-load></image>
				{{item.username}}
			</view>
			<view class="u-f-align-center" v-show="!isguanzhu" @tap="guanzhu">
				<view class="icon iconfont icon-zengjia"></view>关注
			</view>
		</view>
		<view class="index-list2" @tap="opendetail">{{item.title}}</view>
		<view class="index-list3 u-f-justify-align-center" @tap="opendetail">
			<!-- 图片 -->
		...
		<view class="index-list4 u-f-align-center u-f-justfify-space-btw">
			<view class="u-f-align-center">
				<view class="u-f-align-center" :class="{'active':(infonum.index == 1)}" @tap="caozuo('ding')">
					<view class="icon iconfont icon-icon_xiaolian-mian"></view>{{infonum.dingnum}}
				</view>
				<view class="u-f-align-center" :class="{'active':(infonum.index == 2)}" @tap="caozuo('cai')">
